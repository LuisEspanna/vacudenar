...
class AuthAdminView extends TestCase
{
    /** @test */
    public function views_admin_auth()
    {
        ...
        $response->assertStatus(200);
        $response->assertSee('Personas vacunadas según el tipo de vacuna');
    }
}

//Personas vacunadas según el tipo de vacuna